#ifndef NITESH_ARBITRARY_DIM_ARRAY
#define NITESH_ARBITRARY_DIM_ARRAY
...
namespace nm {
    ...
    public:
        ...
        // Copy assignment operator. The dimensionality of the source array must be the same.
        ...
        // Template copy assignment operator. The dimensionality of the source array must be the same. Self-assignment must be a no-op.
        template<typename U>
        Array &operator=(const Array<U, Dim, Dims...> &array) {
            ...
            // Self-assignment check using C-style casting
    ...
    public:
        ...
        // Copy assignment operator. The dimensionality of the source array must be the same. Self-assignment must be a no-op.
        Array &operator=(const Array &array) {
